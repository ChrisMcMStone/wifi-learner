...
class EAPOLState:
    ...
    def buildFrame2(self,
        ...
        B = (min(self.apMacbin,self.staMacbin)
             + max(self.apMacbin,self.staMacbin)
             + min(Anonce,self.Snonce)
             + max(Anonce,self.Snonce))
